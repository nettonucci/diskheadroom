...
![Ajustes do Disk Headroom com o card Updates, versão atual e o botão Check for updates](imagens/settings-updates.png)

2. Ajustes completo (referência)

![Tela de Ajustes completa, incluindo o card de atualizações no final](imagens/settings.png)
